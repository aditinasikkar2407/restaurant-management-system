package javaproject;
//A sample food project for Internal Assessment on restaurant management system
import java.util.*;
...
int vstr,tvstr=0,nvstr,tnvstr=0,vfd,tvfd=0,nvfd,tnvfd=0,fd,tfd=0,amt=0,tamt=0,totalamt=0,
d,totald=0,damt=0,ch;
double vat=0;
...
System.out.println("6. Cripsy American Cornt\t\t\t140");
System.out.println("7. Cripsy Baby Cornt\t\t\t140");
...
System.out.println("6. Murg Tandoorilt\t\t\t190");
...
System.out.println("2. Navratan Kormalt\t\t\t\t180");
System.out.println("3. Kadahi Paneer\t\t\t\t\t\t150");
System.out.println("4. Malai Koftalt\t\t\t\t\t140");
...
System.out.println("8. Chilly Paneer\t\t\t\t 1190");
System.out.println("7. Paneer Manchurian \t\t\t\t90");
System.out.println("9. Sanghai Fried Rice\t\t\t\t240");
System.out.println("10. Veg. Fried rice\t\t\t\t210");
System.out.println("11. Chicken Fried Riceit\t\t\t210");
...
System.out.println("3. Chocolate Walnut Brownie t\t\t90");
...
System.out.println("8. Mango Shakelt\t\t\t\t80");
